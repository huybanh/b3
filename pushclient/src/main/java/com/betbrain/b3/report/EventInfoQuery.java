...
public class EventInfoQuery {
	...
	public static void main(String[] args) {
		...
		ArrayList<EventInfo> scores = (ArrayList<EventInfo>) scoreKey.listEntities(true, mapper);
		...
		ArrayList<EventInfo> statuses = (ArrayList<EventInfo>) statusKey.listEntities(true, mapper);
